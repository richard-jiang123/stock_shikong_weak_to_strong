...
基于 4378 只全A股中随机选取 200 只，回测区间 2025-04-22 至 2026-04-22：
...
| 信号 | 交易笔数 | 胜率 | 平均收益 |
|---|---|---|---|
| 异动不跌 (anomaly_no_decline) | 234 | 63.7% | +5.58% |
| 阳包阴 (bullish_engulfing) | 110 | 55.5% | +2.69% |
| 大阳反转 (big_bullish_reversal) | 2 | 100.0% | +2.01% |
...
| 退出类型 | 笔数 | 胜率 | 平均收益 |
|---|---|---|---|
| 移动止盈 (trailing_stop) | 187 | 89.3% | +12.26% |
| 最终平仓 (final) | 43 | 67.4% | +7.46% |
| 时间止损 (time_exit) | 45 | 26.7% | -4.44% |
| 固定止损 (stop_loss) | 71 | 5.6% | -11.38% |
